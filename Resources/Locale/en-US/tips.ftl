...
tips-dataset-14 = Remember to touch grass in between playing Trieste Port 14 every once in a while.
...
tips-dataset-18 = Remember, falling off the platform is not advised. Blunt force trauma is no good.
tips-dataset-19 = Make sure to refuel the Artifact's radiation collectors from time to time.
...
tips-dataset-24 = Every citizen comes with an emergency medipen in their survival box containing epinephrine and tranexamic acid.
tips-dataset-25 = Flooding can easily kill a large amount of players quickly. It's essential to contain hull breaches before they get out of hand.
tips-dataset-26 = Friendly fire isn't.
...
tips-dataset-31 = As a Traitor, the syndicate or nanotrasen encryption key can be used to communicate through a secure channel with any other traitors who have purchased it.
...
tips-dataset-34 = As a Traitor, damaging the Communications Relay can cripple the communications between Trieste and Sweetwater.
...
tips-dataset-41 = As a Cascade Operative, stick together! While your equipment is robust, your fellow operatives are much better at saving your life: they can drag you away from danger while stunned and provide cover fire.
tips-dataset-42 = As a Cascade Operative, communication is key! Use your radio to speak to your fellow operatives and coordinate an attack plan.
tips-dataset-43 = As a Cascade Operative, remember that stealth is an option. It'll be hard for the captain to fight back if he gets caught off guard by what he thinks is just a regular passenger!
...
tips-dataset-46 = As a Expeditioneer, always carry a GPS on you and take note of Sweetwater's coordinates in case you wander too far off the beaten path.
tips-dataset-47 = As a Expeditioneer, you can use your proto-kinetic accelerator to move yourself in space when in a pinch. Just be wary that it isn't very effective.
tips-dataset-48 = As a Expeditioneer, never forget to mine ore! Ore can be sold to cargo for a pretty penny, be used for construction, and also be used by Scientists for fancy technology.
tips-dataset-49 = As a Expeditioneer, try asking science for a tethergun. It can be used to grab items off of salvage wrecks extremely efficiently!
tips-dataset-50 = As a Expeditioneer, be weary of Drifters. They may be small, but they can quickly put you out of commission if you get stung too many times. Never go out alone.
tips-dataset-51 = Tip #51 does not exist and has never existed. Ignore any rumors to the contrary.
tips-dataset-52 = As a Expeditioneer, consider cooperating with the Cargo Technicians. They can order you a wide variety of useful items, including ones that may be hard to get otherwise, such laser guns and shuttle building materials.
...
tips-dataset-73 = As an Engineer, always be mindful of where the water is. Deconstructing a hull wall will definitely get you reprimanded.
tips-dataset-74 = The Overseer and Head of Personnel can divide and conquer, with the Overseer managing the platform and the HoP managing the basin.
tips-dataset-75 = As the Overseer, you are one of the highest priority targets on the platform. Everything from revolutions, to cascade operatives, to traitors that need to rob you of your unique trident or your life are things to worry about.
tips-dataset-76 = As the Overseer, always take the override codes and pinpointer with you every shift. It's a good idea to give one of these to another head you can trust with keeping it safe.
tips-dataset-77 = As the Overseer, you have absolute access and control over the platform, but this does not mean that being a horrible person won't result in mutiny.
tips-dataset-78 = As the Overseer, try to be active and patrol the platform. Staying in the bridge might be tempting, but you'll just end up putting a bigger target on your back!
...
tips-dataset-91 = The artifact is extremely dangerous. Make sure you're properly informed and geared before getting near it.
...
tips-dataset-94 = Firesuits, winter coats and emergency EVA suits offer mild protection from the cold, allowing you to spend longer periods of time near breaches and in water than if wearing nothing at all.
...
tips-dataset-108 = The Trench to the east is extremely dangerous and hard to see. Be very weary when exploring the sea floor.
...
tips-dataset-114 = Hull breaches take a few seconds to fully flood an area. You can use this time to patch up the hole if you're confident enough, or just run away.
...
tips-dataset-122 = Trieste Port 14 is open source! If there's a change you want to make, or a simple item you want to add, then try contributing to the game. It's not as hard as you'd think it is.
...
tips-dataset-134 = You can tell if an area with firelocks up is flooded by looking to see if the firelocks have lights beside them.
...
tips-dataset-136 = Trieste Port has a discord! Click the button to join for notifications about events or updates!
tips-dataset-137 = Some citizens have heard rumors of squid-like predators that wear dead humanoids like puppets. These are just tall tales made by sailors.
tips-dataset-138 = Cyborg machinery is not waterproof, and will quickly short-circuit in water if exposed for too long. Be cautious when near the hull.
tips-dataset-139 = If you're trapped behind an electrified door, disable the APC or throw your ID at the door to avoid getting shocked!
tips-dataset-140 = If the AI electrifies a door and you have insulated gloves, snip and mend the power wire to reset their electrification!
tips-dataset-141 = If you want to stop your prisoner from escaping from the cell right after being uncuffed, turn on combat mode while uncuffing - this will shove the prisoner down.
tips-dataset-142 = Make sure to clean your illegal implanters with a soap or a damp rag after you use them! Detectives can scan used implanters for incriminating DNA evidence, but not if they've been wiped clean.
