...
uplink-c20r-desc = Old faithful: The classic C-20r Submachine Gun, and two SMG magazines.

uplink-estoc-name = Estoc DMR
uplink-estoc-desc = A designated marksman rifle, fitted with a mid-range optic for longer-range combat, and two rifle magazines (.20 rifle)

uplink-bulldog-name = Bulldog
uplink-bulldog-desc = Lean and mean: Contains the popular Bulldog Shotgun, and two pellet magazines.

uplink-l6-saw-name = L6 Saw
uplink-l6-saw-desc = More dakka: The iconic L6 light machine gun, and two box magazines.
...
uplink-deadman-switch-name = Deadman's Switch
uplink-deadman-switch-desc = A modified remote signaller that triggers when you let go of it. Useful for dramatic ultimatums, bombs optional.
