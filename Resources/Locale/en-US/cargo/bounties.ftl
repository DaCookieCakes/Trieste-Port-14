...
bounty-description-carp = A NanoTrasen hauler is passing nearby. It'd be really funny to sneak a carp somewhere on board. Send one immediately.
...
bounty-description-corn = After the recent NT glassing of the agri-world Tethalon-II, corn imports across the Rim are down. If you have any, send them up.
bounty-description-crayon = Dr. Jones' kid ate all our crayons again. Please send us yours.
bounty-description-cuban-carp = To celebrate the birth of Castro XXVII, ship one Cuban carp to SolGov
...
bounty-description-pen = This is Paper-Pusher vessel IX-812, I'm on my way to the yearly paper pushing party, but I forgot my pens! Send some up immediately.
...
bounty-description-tech-disk = A disaster involving a cup of coffee, a car tire and a light bulb has left the colony on Nerra-II without technology. Send some replacements.
...
bounty-description-lasergun = The people of Antares Prime are staging a revolution against NanoTrasen, send up some energy weapons to assist.
...
bounty-description-chili = Today's the SolGov Chili Cookoff, and, well, a few of us forgot to make some. Please help cover for us.
bounty-description-rollerskates = SolGov Enforcement is proposing a new strategy for helping officers win foot pursuits. Send them a couple so they can learn how bad of an idea this is.
...
bounty-description-cotton-boll = The League of Galactic Hitchhikers has run out of cotton to make towels. They need more before another one is eaten by the Bugblaster Beast of Trall.
bounty-description-microwave-machine-board = Officer Cartway rolled a fork into burrito before putting it into the microwave, causing it to violently explode. We need a replacement.
