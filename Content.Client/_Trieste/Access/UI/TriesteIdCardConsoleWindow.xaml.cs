...
public sealed partial class TriesteIdCardConsoleWindow : DefaultWindow
{
    ...
    private readonly TriesteIdCardConsoleBui _owner;
    ...
    public TriesteIdCardConsoleWindow(TriesteIdCardConsoleBui owner,
        ...
        List<ProtoId<AccessLevelPrototype>> accessLevels)
    {
        ...
        FullNameLineEdit.IsValid = s => s.Length <= maxNameLength;
        ...
        JobTitleLineEdit.IsValid = s => s.Length <= maxIdJobLength;
    ...
    public void UpdateState(TriesteIdCardConsoleBoundUserInterfaceState state)
    {
        ...
        // If the job index IS BELOW 0 that means they don't have a job registered in the station records,
